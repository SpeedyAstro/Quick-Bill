...
public class Form_Dashboard extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        card1 = new admin.card.Card();
        card2 = new admin.card.Card();
        card3 = new admin.card.Card();
        roundPanel1 = new admin.swing.RoundPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        table = new admin.swing.table.Table();
    ...
    private admin.card.Card card1;
    private admin.card.Card card2;
    private admin.card.Card card3;
    private javax.swing.JScrollPane jScrollPane1;
    private admin.swing.RoundPanel roundPanel1;
    private admin.swing.table.Table table;
